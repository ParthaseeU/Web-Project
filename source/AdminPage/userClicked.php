...
<head>
  ...
  <link rel="stylesheet" href="../stylesheets/adminPage/userClicked.css">
...
<body>
  <div class="main-content">
    ...
    <div class="user-information">
      ...
      <div class="user-list">
        ...
        <button class="backButton indigoTheme roundBorder " onclick="redirectToAdmin()"> Back</button>
  ...
  <script src="../scripts/userClicked.js"></script>
</body>
</html>